...
The decision is **gated on `accept_gzip`**, matching `HTTPRequest` — but it's worth being precise about what that option actually does, because the name is a little misleading.
